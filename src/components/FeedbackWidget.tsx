    ...
    <>
      ...
      {!open && (
        <button
          ...
          className="w-10 h-24 rounded-l-xl bg-gradient-to-b from-indigo-500 to-purple-500 text-white shadow-lg hover:shadow-xl hover:w-12 transition-all flex flex-col items-center justify-center gap-1"
          title="意见反馈"
        >
      ...
      {open && (
        <div
          style={{ position: "fixed", right: 16, top: "50%", transform: "translateY(-50%)", zIndex: 9999 }}
          className="w-80 bg-white dark:bg-gray-800 rounded-2xl shadow-2xl border border-gray-100 dark:border-gray-700 overflow-hidden fade-in"
        >
          {submitted ? (
